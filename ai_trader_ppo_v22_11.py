"""
ai_trader_ppo_v22_11.py

V22_11: AI Trader · PPO 训练器（Train / Valid / Test 三阶段）
---------------------------------------------------------

用法示例：
    python ai_trader_ppo_v22_11.py --symbol BTCUSDT --days 365 --total-steps 100000

仅评估模式：
    python ai_trader_ppo_v22_11.py --symbol BTCUSDT --days 365 --mode eval \
        --model-path models/ai_trader_ppo_V22_11_BTCUSDT_best_valid.pt --eval-split test
"""
...
from trading_env_v22_11 import TradingEnvV22MultiTFV11
...
def train_ppo(
    ...
    # 三段环境
    env_train = TradingEnvV22MultiTFV11(symbol=symbol, days=days, segment="train")
    env_valid = TradingEnvV22MultiTFV11(symbol=symbol, days=days, segment="valid")
    env_test = TradingEnvV22MultiTFV11(symbol=symbol, days=days, segment="test")
