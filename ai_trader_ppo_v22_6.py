"""
ai_trader_ppo_v22_6.py

V22_6: AI Trader · PPO 训练器（Train / Valid / Test 三阶段）
---------------------------------------------------------

用法示例：
    python ai_trader_ppo_v22_6.py --symbol BTCUSDT --days 365 --total-steps 100000

仅评估模式：
    python ai_trader_ppo_v22_6.py --symbol BTCUSDT --days 365 --mode eval \
...
from trading_env_v22_6 import TradingEnvV22MultiTF
...
def train_ppo(
    ...
    # 三段环境
    env_train = TradingEnvV22MultiTF(symbol=symbol, days=days, segment="train")
    env_valid = TradingEnvV22MultiTF(symbol=symbol, days=days, segment="valid")
    env_test = TradingEnvV22MultiTF(symbol=symbol, days=days, segment="test")
...
def evaluate_model(
    ...
    env = TradingEnvV22MultiTF(symbol=symbol, days=days, segment=eval_split)
