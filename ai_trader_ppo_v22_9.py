"""
ai_trader_ppo_v22_9.py

V22_9: AI Trader · PPO 训练器（Train / Valid / Test 三阶段）
---------------------------------------------------------

用法示例：
    python ai_trader_ppo_v22_9.py --symbol BTCUSDT --days 365 --total-steps 100000

仅评估模式：
    python ai_trader_ppo_v22_9.py --symbol BTCUSDT --days 365 --mode eval \
        --model-path models/ai_trader_ppo_V22_9_BTCUSDT_best_valid.pt --eval-split test
"""
