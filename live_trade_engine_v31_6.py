...
V31_6 · 多币轮动 · Binance USDT-M 永续合约 实盘引擎（实时循环版）
...
class LiveTradeEngineV31_6:
    ...
    def run_forever(self):
        print("==== 启动 V31_6 多币轮动·Binance USDT-M Futures 实盘引擎（实时循环） ====")
        print(
...
# ===========================
def parse_args():
    p = argparse.ArgumentParser(description="V31_6 多币轮动 · Binance USDT-M Futures 实时引擎")
    p.add_argument(
        "--symbols",
        type=str,
